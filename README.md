...
ms_path_end="bottom 30%"
ms_path_scrub="0.25"
```

Use a smaller `ms_path_scrub` value for less lag. If the draw still feels too fast, the cleanest fix is to give the trigger section more scroll height in CSS.
